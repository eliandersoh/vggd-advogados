...
export const VGD = {
  ...
  stats: [
    { n: "31+", label: "avaliações 5★ no Google" },
  ...
  testimonials: [
    {
      author: "Vanessa Karla",
      date: "Out 2024",
      text: "Gostaria de agradecer pelo trabalho incrível do Dr. Guilherme! De forma solícita, rápida e eficaz solucionou meu problema. Indico de olhos fechados!",
      area: "Cível",
    },
    {
      author: "Ana Maria Lucca",
      date: "Out 2024",
      text: "Superou as expectativas em relação à ação de divórcio.",
      area: "Família",
    },
    {
      author: "Maria Carolina Lobo",
      date: "Out 2024",
      text: "O mais importante na contratação de um advogado é a confiança. Dr. Guilherme é excelente na orientação, na estratégia e na qualidade do trabalho jurídico, atencioso e humano. Profundamente grata — não apenas pelo resultado positivo, mas pelo processo, seriedade, atenção e acompanhamento.",
      area: "Cível",
    },
    {
      author: "Isabela de Carvalho",
      date: "Out 2024",
      text: "A equipe é atenciosa, ágil e atualiza os clientes com frequência. Recomendo fortemente!",
      area: "Geral",
    },
    {
      author: "Margarete Micheletti",
      date: "Out 2024",
      text: "Ressalto o profissionalismo e a agilidade com que o Dr. Luan Galindo encaminhou todo o processo da minha aposentadoria, com todo cuidado e atenção, sempre pronto a esclarecer minhas dúvidas.",
      area: "Previdenciário",
    },
    {
      author: "Geisson do Espírito Santo",
      date: "Out 2024",
      text: "Recomendo a consultoria jurídica. Atendimento sempre rápido, preciso e atencioso. Tive mais contato com o Dr. Guilherme. Ótimos profissionais.",
      area: "Cível",
    },
  ],
